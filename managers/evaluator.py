...
class Evaluator():
    ...
    def eval(self, save=False):
        ...
        auc_roc = round(metrics.roc_auc_score(pos_labels + neg_labels, pos_scores + neg_scores), 4)
        auc_pr = round(metrics.average_precision_score(pos_labels + neg_labels, pos_scores + neg_scores), 4)
